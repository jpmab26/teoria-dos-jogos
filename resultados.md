...
|---|---|---|---|
| Settling time (N) | 2.4 s | 2.2800 s | criterio de banda +-2% |
| Overshoot (N) | 0.0% | -0.0065% | |
| Settling time medio (S) | 4.2827 s | 4.1484 s | 100.000 sims Monte Carlo |
| Settling time desvio-padrao (S) | 0.0146 s | 0.7776 s | |
...
**Nota de modelagem (controlador comutante):** Estado do controlador inativo congelado (sem reset especial na retomada); ver docstring de simulate_switching_monte_carlo em src/ncs_model.py para a justificativa desta escolha.
